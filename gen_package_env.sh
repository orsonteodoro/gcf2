...
SSA_SANITIZE_SIZE=${SANITIZE_SIZE:-19000000} # bytes
...
gen_ssa_autosanitize_list_v2() {
	...
	echo "# Autogenerated list"
	for path in $(find "${PORTAGE_DIR}/" -name "Manifest") \
	do
...
main()
{
	echo "gen_package_env.sh is under construction"
	return
	header
	autofetch_tarballs
	gen_static_package_env
