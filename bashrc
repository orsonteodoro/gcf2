...
gcf_error "(5) Disable CFI for this package.  UBSan may still need to be linked."
...
gcf_error
gcf_error "For case 5 use \`equery b libfile\` to determine the package"
...
" \
	...
	local light_swap_margin="(${ram_size} - 1.3)" # 1.3 comes from total RSS under X + used free
