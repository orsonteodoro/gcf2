...
* /etc/portage/emerge-world-lto-restricted.lst -- Packages in this list are only allowed the default compiler without LTO for @world if statically-linked; otherwise, you may use the preferred LTO compiler.
